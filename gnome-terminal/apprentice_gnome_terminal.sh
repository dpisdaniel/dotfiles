#!/usr/bin/env bash
# Installs the Apprentice colorscheme into Gnome Terminal
# Credits to https://github.com/romainl/apprentice-colorschemes


[[ -z "$PROFILE_NAME" ]] && PROFILE_NAME="apprentice"
[[ -z "$PROFILE_SLUG" ]] && PROFILE_SLUG="apprentice-colors"
[[ -z "$DCONF" ]] && DCONF=dconf
